...
import me.ifen.core.util.ConvertUtils;
import me.ifen.core.util.ServletUtils;
...
public class PropertyFilter {
    ...
    public enum PropertyType {
        S(String.class), I(Integer.class), L(Long.class), N(Double.class), D(Date.class), B(Boolean.class),T(Timestamp.class),F(Float.class);
